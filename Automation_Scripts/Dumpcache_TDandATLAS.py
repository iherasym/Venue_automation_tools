...
#provide server Ip: 10.167.157.83
#provide password: Reuters1
#provide LH names separated by space: CSA01
#Atlas or TD: Atlas
#provide a location where you want to save DumpCache files to your local machine: C:\Users\UC502266\Documents\Functional\CSA\
